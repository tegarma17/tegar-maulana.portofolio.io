...
function AboutPage() {
  return (
    <div className="AboutPage">
      <section className="bg-white py-10 font-main overflow-hidden ">
        <div className="container mx-auto ">
          ...
          >
            ...
            <div className="flex-1 mx-3">
              <h1 className="text-4xl font-bold text-marine mb-4">Tentang Saya</h1>
              <p className="text-lg text-gray-600 mb-6">
                Saya seorang pengembang web profesional yang berdedikasi untuk menciptakan solusi inovatif dan ramah
                pengguna. Dengan pemahaman mendalam tentang berbagai teknologi pengembangan web, saya berfokus pada
            ...
            >
              <div className="card-body text-center">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <h1 className="card-title text-blue text-xl font-bold">Front End Development</h1>
                  <h3 className="text-black text-left text-base my-3">Bahasa Pemrograman: </h3>
                  <div className="text-slate-600 my-3">
                    <p>HTML, JS, CSS</p>
                  </div>
                  <h3 className="text-black text-left text-base my-3">Framework: </h3>
            ...
            >
              <div className="card-body text-center  bg-marine rounded-lg">
                <div className="flex flex-col items-center justify-center">
                  ...
                  <h2 className="card-title text-blue text-xl font-bold">Back End</h2>
                  <h3 className="text-black text-left text-base my-3">Bahasa Pemrograman: </h3>
                  <div className="text-slate-600 my-3">
                    <p>PHP</p>
                  </div>
