...
function PendidikanPage() {
  return (
    <section
      id="pendidikan"
      className="bg-marine  mt-10 py-20 font-main text-white font-bold"
    >
      <div className="container mx-auto ">
        <div className="flex flex-col items-center justify-center space-y-8 ">
          <h1 className="text-center font-bold font-main text-2xl ">
            Pendidikan
          </h1>
          <ul className="timeline timeline-vertical lg:timeline-horizontal text-white">
            ...
            >
              ...
              <div className="timeline-end timeline-box bg-blue border-none">
                SDN 1 Miji Mokerto
              </div>
              <hr />
              <hr />
